...
if ENV["GIT_HOST"] == "GITHUB"
    ...
    const GITHUB_DST_ORGANIZATION = "UnofficialJuliaMirrorRemoveLFS"
    ...
    const src_provider =
        RemoveLFS.Hosts.GitHubSrcHost.new_github_session(
            ;
...
elseif ENV["GIT_HOST"] == "GITLAB"
    ...
    const GITLAB_DST_GROUP = "UnofficialJuliaMirrorRemoveLFS"
    ...
    const src_provider =
        RemoveLFS.Hosts.GitLabSrcHost.new_gitlab_session(
            ;
